...
// Destinations with only the most basic fields
...
async function insertMinimalDestinations() {
  console.log('Inserting destinations with minimal structure...');
