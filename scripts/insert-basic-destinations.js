...
// Destinations with only basic fields that should exist
...
async function insertBasicDestinations() {
  console.log('Inserting destinations with basic structure...');
