...
// Destinations with only the most basic fields that definitely exist
...
async function insertUltraSimpleDestinations() {
  console.log('Inserting destinations with ultra-simple structure...');
