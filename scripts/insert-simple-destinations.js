...
// Destinations with basic structure that matches current table
...
async function insertSimpleDestinations() {
  console.log('Inserting destinations with simple structure...');
  ...
  try {
    ...
    if (verifyError) {
      ...
      console.log('\n📋 Sample destinations:');
      verifyData.slice(0, 3).forEach(dest => {
