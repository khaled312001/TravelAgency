...
const seoSettings = ref({
  siteTitle: 'Wonder Land - وكالة السفر والسياحة',
  siteDescription: 'أفضل وكالة سفر وسياحة في المملكة العربية السعودية. نقدم رحلات داخلية وخارجية، عمرة، وحج بأسعار منافسة.',
  keywords: 'سفر، سياحة، رحلات، عمرة، حج، دبي، تركيا، ماليزيا',
  language: 'ar',
  ogTitle: 'Wonder Land - وكالة السفر والسياحة',
  ogDescription: 'اكتشف العالم مع Wonder Land. رحلات مذهلة وأسعار منافسة.',
  ogImage: 'https://worldtripagency.com/images/og-image.jpg'
})

const metaTags = ref([
  { name: 'author', content: 'Wonder Land' },
