...
async function createAdminTable() {
  try {
    console.log('🚀 بدء إنشاء جدول الإدارة...')
    ...
    if (createError) {
      console.log('جدول admin_users موجود بالفعل أو تم إنشاؤه')
    } else {
    ...
    if (createSessionsError) {
      console.log('جدول admin_sessions موجود بالفعل أو تم إنشاؤه')
    } else {
    ...
    if (createLogsError) {
      console.log('جدول admin_activity_logs موجود بالفعل أو تم إنشاؤه')
    } else {
    ...
    console.log('🌐 يمكنك الآن الوصول للوحة التحكم على: http://localhost:3000/admin/login')
